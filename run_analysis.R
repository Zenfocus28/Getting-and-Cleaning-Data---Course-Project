...
activity_test <- read.table(file.path(dirData, "Y_test.txt"), header = FALSE)
activity_train <- read.table(file.path(dirData,"Y_train.txt"), header = FALSE)

subject_test  <- read.table(file.path(dirData, "subject_test.txt"), header = FALSE)
subject_train <- read.table(file.path(dirData, "subject_train.txt"), header = FALSE)

features_test  <- read.table(file.path(dirData, "X_test.txt" ), header = FALSE)
features_train <- read.table(file.path(dirData, "X_train.txt"), header = FALSE)
